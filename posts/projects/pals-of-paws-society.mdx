...
subtitle: A professional Next.js website developed for a nonprofit animal welfare organization.
...
cardImageUrl: /images/blog/pals-of-paws-society/logo.png
headerImageUrl: /images/blog/pals-of-paws-society/header.png
...
<MDXImage
	src="/images/blog/pals-of-paws-society/adopt-page.png"
	alt="A screenshot of the adoption page showing several animals and the website header."
	className="aspect-[1.2656]"
/>
...
<MDXImage
	src="/images/blog/pals-of-paws-society/transform.png"
	alt="A screenshot of code showing the logic used to clean up animal data."
	className="aspect-[1.85]"
/>

I used the adapter pattern with [Typescript](/posts/tools/typescript) to combine both services into a common "Animal" type interface, with which I could then display the animals side-by-side.

<MDXImage
	src="/images/blog/pals-of-paws-society/petfinder-adapter.png"
	alt="A screenshot of code used to convert Petfinder animals to an Animal interface."
	className="aspect-[1.85]"
/>
...
The downside of this approach is that the page has a very large file size - with
over 300 animals loaded statically on the client-side. This has had a negative impact
on the Lighthouse performance scores for the page.

<MDXImage
	src="/images/blog/pals-of-paws-society/lighthouse-large-dom.png"
	alt="Lighthouse scores showing a performance score of 76, and a warning that the DOM contains 910 elements"
	className="aspect-[3]"
/>
...
<MDXImage
	src="/images/blog/pals-of-paws-society/shallow-routing.png"
	alt="A screenshot of code demonstrating Next.js shallow routing."
	className="aspect-[1]"
/>

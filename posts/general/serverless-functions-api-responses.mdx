...
subtitle: Returning an API response early may terminate your Lambda function.
description: The point at which you choose to send an API response in your code can affect the execution order of your serverless functions.
cardImageUrl: "/images/blog/serverless-functions-api-responses/res-send.png"
headerImageUrl: "/images/blog/serverless-functions-api-responses/header.png"
...
<MDXImage
	src={"/images/blog/serverless-functions-api-responses/stripe-docs-image.png"}
	alt="Image of Stripe documentation excerpt stating, Your endpoint must quickly return a successful status code (2xx) prior to any complex logic that could cause a timeout. For example, you must return a 200 response before updating a customer’s invoice as paid in your accounting system."

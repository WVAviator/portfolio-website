...
const ProjectShowcase: React.FC<ProjectShowcaseProps> = ({
  ...
  const linkUrl = {
    ...
    published: project.projectUrl || project.githubUrl,
  }[linkType];
  return (
    <Link
      href={linkUrl || '#'}
      className="prose prose-sm flex flex-col items-center"
    >
      <h2 className="pen-drawn dark:pen-drawn-dark font-medium">
        {alternateTitle || project.title}
      </h2>

      ...
      <div className="grid grid-cols-1 py-8 lg:grid-cols-2 lg:py-16 gap-y-6">
        <div className="p-2 lg:p-6">
          <div className=" flex flex-col items-center justify-center gap-9 sm:gap-12 md:gap-14 min-w-[50%] lg:items-start ">
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-5xl xl:text-6xl text-center lg:text-left font-medium leading-normal sm:leading-normal md:leading-normal lg:leading-snug xl:leading-normal pen-drawn">

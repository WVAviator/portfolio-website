...
const PostCard: React.FC<PostCardProps> = ({ post }) => {
  ...
  return (
    <Link
      ...
      className="flex flex-col aspect-[0.85] min-w-[15rem] w-[90%] max-w-[21rem] sm:w-[21rem] xsm:h-[30rem] p-4 border rounded shadow-md bg-primary-50 hover:shadow-lg transition-shadow duration-200 dark:bg-primary-900 dark:border-none"
    >
      ...
      <h2
        ...
        className="text-md text-center dark:text-white font-semibold xsm:text-left xsm:text-lg mt-4"
      >
        {post.title}
      </h2>
      ...
      <p
        ...
        className="text-center text-sm xsm:text-left dark:text-white xsm:text-base my-3"
      >
        {truncatedDescription}
      </p>
      <p className="mt-auto text-center text-xs xsm:text-left dark:text-gray-300 xsm:text-sm">

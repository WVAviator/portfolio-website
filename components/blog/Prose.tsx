...
const Prose = ({ post }: Props) => {
	return (
		<article className="prose md:prose-lg lg:prose-xl prose-slate prose-a:cursor-pointer hover:prose-a:text-primary-400 prose-a:transition-colors prose-a:duration-200 prose-code:before:content-[''] prose-code:after:content-['']">
			<PostHeader
